...
function make(deps) {
  ...
  return {
    ...
    /** The 6-digit Netflix verification code emailed when logging in on a new device (read from our own inbox). */
    verificationCode: (acc) => require('./oliviahousehold').verificationCode(acc),
