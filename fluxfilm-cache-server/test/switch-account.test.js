...
(async () => {
  ...
  const card = new Function('return (function(){ var MON = ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]; function esc(v){return String(v==null?"":v);} function statusPill(){return "";} function svcIcon(){return "";} function waLink(){return "#";} function prettyDate(v){return String(v||"");} ' + grab('istDate') + grab('daysLeft') + grab('subCard') + ' return subCard; })()')();
