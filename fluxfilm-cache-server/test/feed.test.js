...
(async () => {
  ...
  ok('release line: future = Coming soon · date, past = Released / Out since', /^🗓️ Coming soon · \d{1,2} \w+$/.test(h.feedRelease_(day(5), 'movie')) && /^🎬 Released/.test(h.feedRelease_(day(-5), 'movie')) && /^📺 Out since/.test(h.feedRelease_(day(-5), 'series')) && h.feedRelease_('nope') === '');
