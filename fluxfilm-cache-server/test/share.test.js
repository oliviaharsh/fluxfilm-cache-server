...
(async () => {
  ...
  ok('feed post passes the catalog info (cheapest plan) even when the post has no buy button', /shareInfo: info \|\| feedServiceInfo_\(p\.ctaService \|\| p\.service, plans, shareText_\.data\.levels\)/.test(store) && /onClick: \(\) => feedShare_\(p, shareInfo, how => \{/.test(store));
  ...
  ok('poster: TMDB via our proxy at w500 with size; uploaded picture without size; outside URLs dropped', JSON.stringify(I.postImage('/tmdb-img/t/p/w780/kPKAigYUlWRpnfo4Ptiwlz4FWXU.jpg')) === JSON.stringify({ url: 'https://shop.fluxfilm.in/poster/w500/kPKAigYUlWRpnfo4Ptiwlz4FWXU.jpg', width: 500, height: 750, type: 'image/jpeg' }) && I.postImage('/feed-img/fp0123456789?v=1').url === 'https://shop.fluxfilm.in/feed-img/fp0123456789?v=1' && !I.postImage('/feed-img/fp0123456789?v=1').width && I.postImage('https://evil.example.com/x.jpg') === null && I.postImage('/tmdb-img/t/p/w780/../../x.jpg') === null);
  ...
  ok('og:image = poster (absolute, w500, 500×750, jpeg) + twitter:image', metaContent(html, 'property', 'og:image') === 'https://shop.fluxfilm.in/poster/w500/kPKAigYUlWRpnfo4Ptiwlz4FWXU.jpg' && metaContent(html, 'property', 'og:image:width') === '500' && metaContent(html, 'property', 'og:image:height') === '750' && metaContent(html, 'property', 'og:image:type') === 'image/jpeg' && metaContent(html, 'name', 'twitter:image') === metaContent(html, 'property', 'og:image'));
